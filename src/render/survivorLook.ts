...
/** Multiply sobre color existente cuando hay map (mantiene variación). 0xc8bca8 × 1.15/canal para leer de noche. */
...
/** Roughness acento visor. 0.3915 × 0.87 para leer el visor de noche. */
export const SURVIVOR_ACCENT_ROUGHNESS = 0.340605;
