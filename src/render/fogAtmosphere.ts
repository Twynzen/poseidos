 ...
 * Noche azul-gris un poco más clara (r 0.092575 = 0.0805 × 1.15; g 0.119025 = 0.1035 × 1.15; b 0.161 = 0.14 × 1.15)
 * para que el horizonte se lea; día frío claro igual (0.26 / 0.33 / 0.47).
 * Dawn naranja/rosa; dusk ámbar/rojo.
 */
export const SKY_NIGHT: Rgb = { r: 0.092575, g: 0.119025, b: 0.161 };
