...
export const RAIN_STREAK_LENGTH_NIGHT = 0.72;
...
export const RAIN_OPACITY_NIGHT_ADD = 0.2;
...
/** scaleY sobre geo de largo día. Día = 1; noche d=0 → 0.72/0.55. */
...
/** Opacidad: 0.22 + i×0.45; noche suma +0.20 × nightMix. */
