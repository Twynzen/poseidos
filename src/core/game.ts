...
export class Game {
  ...
  private softReset(): void {
    ...
    // R: WorldView nuevo = player spawn + bed/door/nameplate/loot focus + grass + rain + camera + muzzle + impact + tracers + melee swing + player loco + hit lean fresco; leftover origin 0,0 / opacity 1 / mid-swing / mid-stride / mid-recoil no filtra.
    this.view.dispose();
    this.view = createWorldView(this.map, this.containers);
