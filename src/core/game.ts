...
export class Game {
  ...
  private softReset(): void {
    ...
    // R: WorldView nuevo = grassTime 0 + rain Y/vx/vy/vz/opacity/scaleY/count/hide fresco; leftover sway/caída/viento/speed/deriva/wrap/look/largo/active/hide no filtra.
    this.view.dispose();
    this.view = createWorldView(this.map, this.containers);
