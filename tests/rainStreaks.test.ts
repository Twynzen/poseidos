...
describe("constantes", () => {
  ...
  test("opacity 0.3345925 + i×0.595125; noche +0.39675; active min 7; night cut 0.191; hide 0.0174", () => {
...
describe("rainStreakOpacity", () => {
  test("día: 0.3345925 + i×0.595125; noche suma +0.39675 × nightMix", () => {
    expect(rainStreakOpacity(0, 1)).toBeCloseTo(0.3345925, 10);
    expect(rainStreakOpacity(1, 1)).toBeCloseTo(0.3345925 + 0.595125, 10);
    expect(rainStreakOpacity(1, 0)).toBeCloseTo(0.3345925 + 0.595125 + 0.39675, 10);
    expect(rainStreakOpacity(0.5, 0)).toBeCloseTo(0.3345925 + 0.5 * 0.595125 + 0.39675, 10);
    expect(rainStreakOpacity(1, 0.08)).toBeCloseTo(0.3345925 + 0.595125 + 0.39675 * 0.92, 10);
  });
});
