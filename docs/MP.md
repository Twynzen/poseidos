...
| Possession trust / gates | sí | trust + TTLs + lastApplied / lastRejected / gateLine / moodBias / toneBias / memorySummary / lineSource (ya validados); clientes no ven intents |
