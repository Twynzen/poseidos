...
- **Última rutina:** 2026-08-12 — touch knockback
- **Qué quedó (esta corrida):**
  - Toque hostil: `tryApplyTouchKnockback` aleja al player (`TOUCH_KNOCKBACK_DIST` 0.4) con la misma colisión que `PlayerSim.move` (full / slide X / slide Y); overlap ~0 → fallback +X.
  - `TOUCH_DAMAGE` / contact polish (CD 1.15, touchRange 0.58, grace 6, damage 12) sin cambios.
