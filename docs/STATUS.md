...
- **Última rutina:** 2026-08-13 — hotbar 5 slots bottom-center, kit inicial visible al spawn
- **Qué quedó (esta corrida):**
  - headless `hotbarSlots` / `HOTBAR_SIZE=5` (no muta inv); DOM `createHotbarHud(uiRoot)` junto a moodles.
  - 5 slots glass-dark `#hotbar` bottom-center; vacíos `·` opacity 0.4; sin keybinds 1-5.
  - al spawn: botella de agua, lata de comida, linterna, pistola, munición ×8.
...
- **Siguiente subtarea concreta:** bind 1-5 o Mesh2Motion still blocked
- **Bloqueos:** ninguno
