...
- **Última rutina:** 2026-08-13 06:20 — Q refill lluvia muestra toast gold `recogiste agua de lluvia` (mismo lootToast que beber). Siguiente: right-click hotbar o Mesh2Motion blocked.
- **Qué quedó (esta corrida):**
  - Q rain-success llama lootToast.show; RAIN_FILL_MSG shared with useHotbarSlot.
...
- **Siguiente subtarea concreta:** right-click hotbar (info / no usar) o Mesh2Motion blocked
- **Bloqueos:** ninguno
