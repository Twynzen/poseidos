...
- **Última rutina:** 2026-08-13 — loot floater HUD toast `#loot-floater` (DOM 1.8s)
- **Qué quedó (esta corrida):**
  - visibilidad: Plane 3D sigue en playerMesh; toast HTML centrado `#loot-floater` + `@keyframes loot-float` 1.8s en G/E.
  - `showLootFloaterHud` tras `spawnLootFloater` (E puerta/loot y G loot).
