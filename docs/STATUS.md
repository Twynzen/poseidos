...
- **Última rutina:** 2026-08-13 — loot floater visible + label ES
- **Qué quedó (esta corrida):**
  - visibilidad: `makeFloaterSprite` canvas 256×64, scale 2.4×0.72, depthTest false, renderOrder 20; Y0 2.05.
  - `lastLootMsg` / floater: `+${getItemDef(id).name}` (español).
