...
- **Última rutina:** 2026-08-13 — arrastrar filas del panel I reordena stacks (swap).
...
- **Siguiente subtarea concreta:** doble clic en fila del panel I usa el stack (como hotbar; aún no existe).
- **Bloqueos:** ninguno
