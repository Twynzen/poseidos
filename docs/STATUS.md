...
- **Última rutina:** 2026-08-13 — loot floater Plane en playerMesh + label ES
- **Qué quedó (esta corrida):**
  - visibilidad: `makeFloaterMesh` PlaneGeometry 2.4×0.72, MeshBasicMaterial, `playerMesh.add`, frustumCulled false, renderOrder 20; Y0 2.05; TTL 1.8.
  - `lastLootMsg` / floater: `lootFloaterLabel(+nombre)` (español).
