...
- **Última rutina:** 2026-08-13 — loot markers ámbar
- **Qué quedó (esta corrida):**
  - MarkerRole `loot`: anillo `0xd4a03a`, badge `0xf0c060`, emissive `0x403010`, glifo ▣.
  - `worldView`: un grupo por contenedor en `(x+0.5, 0, y+0.5)` con `attachRoleMarkers("loot")`; siempre visible (no FOV). Dispose de grupos.
