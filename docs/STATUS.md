...
- **Última rutina:** 2026-08-13 — bugfix Shift+U snapshot en keydown de U. Siguiente: siguiente slice UI/survival pequeño.
- **Qué quedó (esta corrida):**
  - **U tirar** 1 del slot hotbar al tile del player (WorldContainer; G/E loot; toast gold `tiraste <name>`).
  - **Shift+U stack** tira el stack entero; toast `tiraste munición ×8` si qty>1. Shift se captura en el keydown de U (no en el tick / `sprinting`).
...
- **Siguiente subtarea concreta:** siguiente slice UI/survival pequeño
- **Bloqueos:** ninguno
